...
# But unlike pre_process_docs, it takes in a doc itself
def pre_process_doc(doc):
    st.session_state.doc_loader = PyPDFLoader(file_path=doc)
...
prompt = st.text_input(label="Ask anything related to the pdf you provided.")

file = st.file_uploader("Choose a pdf", accept_multiple_files=False, type="pdf")

if file:
    file_name = "./temp/temp.pdf"
    with open(file_name, "wb") as f:
        f.write(file.getvalue())
    pre_process_doc(file_name)
